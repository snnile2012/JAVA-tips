...
String的底层实现是char类型的数组，而在java语境中，数组的长度由int类型来表示，也就是说数组的最大长度为Integer.MAX_VALUE:（2^31）-1 = 2147483647；  
![image](https://github.com/snnile2012/JAVA-tips/blob/master/pics/int_max.png)
![image](https://github.com/snnile2012/JAVA-tips/blob/master/pics/geometric_sequence.png)
